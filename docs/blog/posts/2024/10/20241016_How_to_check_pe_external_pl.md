...
Check this blog post to learn how to do it: [Find cross-tenant private endpoint connections in Azure](https://www.jannemattila.com/azure/2024/06/17/private-endpoint-connections.html)

This is a copy of the script used in the blog post in case it disappears: 

```powershell title="scan-private-endpoints-with-manual-connections.ps1"
